...
require_once './clases/app/Pedido.php';
...
if (isset($_SESSION["usuario"])) {
    if(is_array($_SESSION['orderSuggested'])){
        foreach ($_SESSION['orderSuggested'] as $indice => $arreglo) {
            ...
            $lista .= "<a href='#!'><img src='app/productos/fotos/{$arreglo['imagen']}' alt='Image'></a>";
            ...
            $lista .= "<span class='d-sm-block d-md-none'>Precio sin descuento: </span><span class='cart-item-price'>$ {$arreglo['precioLista']}</span>";
            $lista .= '</div>';
            $lista .= '<div class="col-12 col-lg-1 text-center">';
            $lista .= "<span class='d-sm-block d-md-none'>Descuento: </span><span class='cart-item-price'>{$arreglo['descuento']}</span>";
            $lista .= '</div>';
            $lista .= '<div class="col-12 col-lg-2 text-center">';
            $lista .= "<span class='d-sm-block d-md-none'>Precio con descuento: </span><span class='cart-item-price'>$ {$arreglo['precio']}</span>";
            $lista .= '</div>';
            $lista .= '<div class="col-12 col-lg-2 text-center">';
        ...
        <section class="pt-0">
            <div class="container">
                <div class="row mb-1 d-none d-lg-flex">
                    <div class="col-lg-9">
                        <div class="row pr-6">
                            ...
                            <div class="col-lg-2 text-center"><span class="eyebrow">Precio sin descuento</span></div>
                            <div class="col-lg-1 text-center"><span class="eyebrow">%</span></div>
                            <div class="col-lg-2 text-center"><span class="eyebrow">Precio con descuento</span></div>
                            <div class="col-lg-2 text-center"><span class="eyebrow">Cantidad</span></div>
                ...
                <div class="row gutter-2 gutter-lg-4 justify-content-end">
                    ...
                    <div class="col-lg-9 cart-item-list">
                    ...
                    <div class="col-lg-3">
                        ...
                        <button class="btn btn-lg btn-primary btn-block mt-1 order-suggested">Pasar al carrito</button>
                    </div>
