                ...
                <div class="modal-body">
                    <div class="modal-body">
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-4">
                                    <label for="nit">Nit <span class="required-label">*</span></label>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="nombreComercial">Nombre comercial <span class="required-label">*</span></label>
                                    <input type="text" class="form-control" id="nombreComercial" placeholder="" name="nombreComercial"  value="" required>
                                </div>
                                <div class="col-md-6">
                                    <label for="celular">Celular <span class="required-label">*</span></label>
                                    <input type="text" class="form-control" id="celular" placeholder="" name="celular"  value="" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" id="observaciones" placeholder="" name="observaciones"  value="" rows="7"></textarea>
                        </div>
                    </div>               
                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        tabla = $('#tabla').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "app/usuarios/proveedores/proveedoresAcciones.php",
                "type": "POST",
                "data": { "accion": 'Listar' }
            },
            "columns": [
        ...
        $("#btnNuevo").click(function () {
            ...
            $(".modal-title").text("ADICIONAR PROVEEDOR");
        ...
        $(document).on("click", ".btnBorrar", function () {
            nit = $(this).closest('tr').find('td:eq(2)').text();
