            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        Pedidos
                        <a href="principal.php?CONTENIDO=app/pedidos/pedidosFormulario.php" type="button" class="btn btn-outline-primary btn-round ml-auto">
                            Adicionar
                        </a>
                    </div>
                </div>
            ...
            "columns": [
                ...
                {"data": "1",
                    "render": function (data, type, row) {
                        ...
                        return '<h6>Cliente: ' + row[1] + '</h6>' + '<h6>Vendedor: ' + Fac + '</h6>' + '<h6>Fecha documento: ' + row[3] + '</h6>' + '<h6>Fecha facturacion: ' + fechaFac + '</h6>' + '<h6>Direccion: ' + direccion + '</h6>';
                    }
                },
                {"data": "0",
                    "render": function (data, type, row) {
                ...
                {"data": "7",
                    "render": function (data, type, row) {
                        return '<h6>Subtotal: ' + row[7] + '</h6>' + '<h6>Flete: ' + row[8] + '</h6>' + '<h6>Total: ' + row[9] + '</h6>';
                    }
                },
                {"data": null,
                    ...
                    "render": function (data, type, row) {
                        ...
                        var entregar = "<a class='ml-4 btnEntregar'><img src='imagenes/pedidos.png'></a>";
                        var eliminar = "<a class='ml-4 btnAnular'><img src='imagenes/anularFactura.png' title='Eliminar'></a>";
                        return row[10] == 'Pendiente' ? entregar + eliminar : row[10] == 'Orden de compra' ? detalle + eliminar : detalle + entregar;
                    }
                },
            ],
        ...
        $(document).on("click", ".btnEntregar", function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location = 'principal.php?CONTENIDO=app/pedidos/pedidosEntrega.php&codigoPedido=' + codigo;
                } else {
                    window.open('app/pedidos/pedidosPdf.php?codigoPedido=' + codigo, '_blank');
                }
            });
        });
