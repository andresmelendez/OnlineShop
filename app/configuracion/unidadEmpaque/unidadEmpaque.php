...
<div class="page-inner">
    <div class="page-header">
        <h4 class="page-title">Unidad de empaque</h4>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        tabla = $('#tabla').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "app/configuracion/unidadEmpaque/unidadEmpaqueAcciones.php",
                "type": "POST",
                "data": {"accion": 'Listar'}
            },
            "columns": [
        ...
        $("#btnNuevo").click(function () {
            ...
            $(".modal-title").text("ADICIONAR UNIDAD DE EMPAQUE");
        ...
        $(document).on("click", ".btnEditar", function () {
            ...
            $(".modal-header").css("color", "white");
            $(".modal-title").text("MODIFICAR UNIDAD DE EMPAQUE");
