                ...
                <div class="modal-body">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="porcentaje" placeholder="" name="porcentaje"  value="" maxlength="50" required>
                        </div>
                    </div>               
                </div>
...
<div class="page-inner">
    <div class="page-header">
        <h4 class="page-title">Impuestos</h4>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        tabla = $('#tabla').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "app/configuracion/impuestos/impuestosAcciones.php",
                "type": "POST",
                "data": {"accion": 'Listar'}
            },
            "columns": [
        ...
        $("#btnNuevo").click(function () {
            ...
            $(".modal-title").text("ADICIONAR IMPUESTO");
        ...
        $(document).on("click", ".btnEditar", function () {
            ...
            $(".modal-header").css("color", "white");
            $(".modal-title").text("MODIFICAR IMPUESTO");
